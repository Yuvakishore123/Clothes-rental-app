                ...
                {order.orderItems.map((item: any) => (
                  <TouchableOpacity
                    ...
                    <View style={style.orderInfoContainer}>
                      <Text style={style.orderDate}>{item.createdDate}</Text>
                      <Text style={style.productName}>Order Id: {item.id}</Text>
...
const OrderDetailsModal = ({order, onClose, visible}) => {
  ...
  return (
    <Modal
      ...
      <View
        style={{backgroundColor: Colors.main, width: '100%', height: '120%'}}>
        <View style={style.modalContainer}>
          <ScrollView style={{flex: 1}}>
            <View style={{marginTop: 10}}>
              <Text style={style.orderid}>Order ID: {order.id}</Text>
