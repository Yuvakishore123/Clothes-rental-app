...
var _index8 = _interopRequireDefault(require("../../../_core/getUTCMonth/index.js"));

var _index9 = _interopRequireDefault(require("../../../_core/getUTCDate/index.js"));

var _index10 = _interopRequireDefault(require("../../../_core/getUTCFullYear/index.js"));
...
var formatters = {
  ...
  G: function (date, token, localize) {
    var era = (0, _index10.default)(date) > 0 ? 1 : 0;
  ...
  y: function (date, token, localize) {
    // Ordinal number
    if (token === 'yo') {
      var signedYear = (0, _index10.default)(date); // Returns 1 for 1 BC (which is year 0 in JavaScript)
  ...
  u: function (date, token) {
    var year = (0, _index10.default)(date);
    return (0, _index7.default)(year, token.length);
  },
  // Quarter
  Q: function (date, token, localize) {
    var quarter = Math.ceil(((0, _index8.default)(date) + 1) / 3);
  ...
  M: function (date, token, localize) {
    var month = (0, _index8.default)(date);
  ...
  d: function (date, token, localize) {
    if (token === 'do') {
      return localize.ordinalNumber((0, _index9.default)(date), {
        unit: 'date'
      });
    }
