...
var _index7 = _interopRequireDefault(require("../_core/setDate/index.js"));
...
function setWeekYear(dirtyDate, dirtyWeekYear, dirtyOptions) {
  ...
  (0, _index8.default)(firstWeek, weekYear, 0, firstWeekContainsDate);
  firstWeek.setHours(0, 0, 0, 0);
  date = (0, _index2.default)(firstWeek, dirtyOptions);
  (0, _index7.default)(date, (0, _index6.default)(date) + diff);
  return date;
}
