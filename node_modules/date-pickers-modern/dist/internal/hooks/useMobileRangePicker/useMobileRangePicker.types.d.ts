...
import { DateOrTimeView, UsePickerParams, BaseNextPickerProps, PickersModalDialogSlotsComponent, PickersModalDialogSlotsComponentsProps, ExportedBaseToolbarProps, MobileOnlyPickerProps, UsePickerViewsProps } from '../../../internals';
...
export interface UseMobileRangePickerSlotsComponentsProps<TDate, TView extends DateOrTimeView> extends Pick<PickersModalDialogSlotsComponentsProps, 'dialog' | 'mobilePaper' | 'mobileTransition'>, ExportedPickersLayoutSlotsComponentsProps<DateRange<TDate>, TView> {
