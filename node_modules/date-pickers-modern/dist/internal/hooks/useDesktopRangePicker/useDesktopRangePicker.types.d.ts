...
import { DateOrTimeView, UsePickerParams, BaseNextPickerProps, PickersPopperSlotsComponent, PickersPopperSlotsComponentsProps, ExportedBaseToolbarProps, DesktopOnlyPickerProps, UsePickerViewsProps } from '../../../internals';
...
export interface UseDesktopRangePickerSlotsComponentsProps<TDate, TView extends DateOrTimeView> extends Pick<PickersPopperSlotsComponentsProps, 'desktopPaper' | 'desktopTransition' | 'desktopTrapFocus' | 'popper' | 'paperContent'>, ExportedPickersLayoutSlotsComponentsProps<DateRange<TDate>, TView> {
