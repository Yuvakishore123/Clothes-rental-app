...
export interface TimePickerSlotsComponent<TDate> extends MobileTimePickerSlotsComponent<TDate>, DesktopTimePickerSlotsComponent<TDate> {
}
...
export interface TimePickerProps<TDate> extends Omit<DesktopTimePickerProps<TDate>, 'components' | 'componentsProps'>, Omit<MobileTimePickerProps<TDate>, 'components' | 'componentsProps'> {
    /**
