...
export interface PickersModalDialogSlotsComponentsProps extends Pick<PickersSlotsComponentsProps, 'actionBar'> {
    /**
...
export declare function PickersModalDialog(props: React.PropsWithChildren<PickersModalDialogProps>): JSX.Element;
