...
export type ExportedDateInputProps<TDate> = Omit<DateInputProps<TDate>, 'inputFormat' | 'inputValue' | 'onBlur' | 'onChange' | 'open' | 'openPicker' | 'value' | 'TextFieldProps' | 'validationError' | 'components'>;
export declare const PureDateInput: React.ForwardRefExoticComponent<DateInputProps<unknown> & React.RefAttributes<HTMLDivElement>>;
