 ...
 */
export interface BaseNextPickerProps<TValue, TDate, TView extends DateOrTimeView, TError, TExternalProps extends UsePickerViewsProps<TValue, TView, any, any>, TAdditionalProps extends {}> extends UsePickerBaseProps<TValue, TView, TError, TExternalProps, TAdditionalProps> {
    /**
 ...
 */
export interface BaseNextPickerInputProps<TValue, TDate, TView extends DateOrTimeView, TError> extends Omit<MakeOptional<BaseNextPickerProps<TValue, TDate, TView, TError, any, any>, 'openTo' | 'views'>, 'viewRenderers'> {
}
/**
