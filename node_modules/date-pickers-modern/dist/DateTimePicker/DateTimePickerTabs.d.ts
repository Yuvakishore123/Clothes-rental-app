...
export interface DateTimePickerTabsProps extends ExportedDateTimePickerTabsProps, BaseTabsProps<DateOrTimeView> {
    /**
...
declare const DateTimePickerTabs: {
    (inProps: DateTimePickerTabsProps): JSX.Element | null;
    propTypes: any;
};
