...
export declare const useSingleInputDateRangeField: <TDate, TChildProps extends {}>({ props, inputRef, }: UseSingleInputDateRangeFieldParams<TDate, TChildProps>) => import("../internals").UseFieldResponse<TChildProps>;
